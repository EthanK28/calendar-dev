...
<body class="header">
	<div class="container">
		...
		<div class="container">
			<div class="row">
				<div class='col-md-8'>
					<form:form role="form" action="eventcreation" method="post" commandName="eventForm">
						<table>
							<thead>
								<tr>
									<div class="form-group">
										<td colspan="2" align="center"><h2>이벤트 만들기</h2></td>
									</div>
								</tr>
							</thead>
							<tbody>
								<tr>
								<td>
									<form:label path="id">when:</form:label>
								</td>
								...
								<td>
									<div class="form-group">
										...
										<form:input path="when" type='text' class="form-control" /> 
												<span class="input-group-addon"> 
												<span class="glyphicon glyphicon-calendar"></span>
											</span>	
										</div>
								...
								<tr>
									<td><form:label path="id">when:</form:label></td>
									<td><form:input path="when" class="form-control" /></td>
								</tr> 								
								<tr>
									<td><form:label path="id">summary:</form:label></td>
									<td><form:input path="summary" class="form-control" /></td>
								</tr> 
								<tr>
									<td><form:label path="id">owner:</form:label></td>
									<td><form:input path="owner" class="form-control" /></td>
								</tr> 
								<tr>
									<td><form:label path="id">description:</form:label></td>
									<td><form:input path="description" class="form-control" /></td>
								</tr>								
								<tr>
									<td><form:label path="id">numLikes:</form:label></td>
									<td><form:input path="numLikes" class="form-control" /></td>
								</tr>		
								<tr>
									<td><form:label path="id">eventLevel:</form:label></td>
									<td><form:input path="eventLevel" class="form-control" /></td>
								</tr>													
								<tr>
									<td colspan="2" align="center"><input type="submit"
										class="button" value="이벤트 생성" /></td>
								</tr>
							</tbody>
						</table>
					</form:form>
